...
The home page includes keyboard-accessible category and publisher filters so visitors can narrow the featured game list without leaving the landing page.
...
The **Issue Triage Board** canvas (`.github/extensions/issue-triage-board/`) ranks open GitHub issues, explains why the top three need attention, and lets you add a selected issue to the current Copilot session context.
